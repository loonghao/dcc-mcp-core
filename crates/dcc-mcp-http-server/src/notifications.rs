...
//!
//! The notifier subscribes to [`dcc_mcp_job::job::JobManager`] and routes each
//! [`dcc_mcp_job::job::JobEvent`] to the SSE stream of the owning session.
//!
//! # Session correlation
//!
...
use dcc_mcp_job::job::{JobEvent, JobStatus};
...
/// Bridges [`dcc_mcp_job::job::JobManager`] state transitions and
...
impl JobNotifier {
    ...
    /// Handle a [`JobEvent`] emitted by [`dcc_mcp_job::job::JobManager`].
    ///

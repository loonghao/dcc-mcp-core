...
//!
//! The full `McpHttpConfig` aggregate now lives in the sibling
//! [`aggregate`] module and is re-exported here alongside the cohesive
//! sub-config structs it composes.

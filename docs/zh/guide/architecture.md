...
- **34 个 workspace 成员**（33 个功能 crate + `workspace-hack`）— 以根目录 `Cargo.toml` 为准，按需选择性依赖
...
- `search_tools`、`describe_tool`、`call_tool` — 固定 gateway MCP wrappers，覆盖动态 capability index

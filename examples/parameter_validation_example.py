...
# Add the parent directory to the path so we can import the dcc_mcp_core package
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from dcc_mcp_core.parameter_models import with_parameter_validation
from dcc_mcp_core.parameter_groups import with_parameter_groups, ParameterGroup
...
@with_parameter_groups(
    ParameterGroup("identification", "User identification parameters", ["username", "email"], required=True, exclusive=True),

...
fn register_models(m: &Bound<'_, PyModule>) -> PyResult<()> {
    add_classes!(
        ...
        dcc_mcp_models::SkillRuntimeDescriptor,
        dcc_mcp_models::SkillRuntimeKind,
        dcc_mcp_models::SkillRuntimeReport,
        dcc_mcp_models::SkillRuntimeState,
        dcc_mcp_models::SkillRuntimeSummary,
...
fn register_utils(m: &Bound<'_, PyModule>) -> PyResult<()> {
    add_functions!(
        ...
        dcc_mcp_skills::paths::py_get_team_skill_paths_from_env,
        dcc_mcp_skills::paths::py_get_app_user_skill_paths_from_env,
        dcc_mcp_skills::paths::py_get_app_team_skill_paths_from_env,
        dcc_mcp_skills::paths::py_get_user_skills_dir,
        dcc_mcp_skills::paths::py_get_team_skills_dir,
        dcc_mcp_skills::paths::py_copy_skill_to_user_dir,
        dcc_mcp_skills::paths::py_copy_skill_to_team_dir,
        dcc_mcp_skills::feedback::py_record_skill_feedback,
        dcc_mcp_skills::feedback::py_get_skill_feedback,
        dcc_mcp_skills::versioning::py_get_skill_version_manifest,
        dcc_mcp_pybridge::python::py_unwrap_value,
        dcc_mcp_pybridge::python::py_unwrap_parameters,
        dcc_mcp_pybridge::python::py_wrap_value,
        ...
        dcc_mcp_pybridge::python::json_dumps,
    ...
    add_classes!(
        m,
        dcc_mcp_pybridge::type_wrappers::BooleanWrapper,
        dcc_mcp_pybridge::type_wrappers::IntWrapper,
        dcc_mcp_pybridge::type_wrappers::FloatWrapper,
        dcc_mcp_pybridge::type_wrappers::StringWrapper,
        dcc_mcp_skills::feedback::SkillFeedback,
        dcc_mcp_skills::versioning::SkillVersionManifest,
        dcc_mcp_skills::versioning::SkillVersionEntry,
...
fn register_constants(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    add_constants!(
        ...
        "ENV_SKILL_PATHS"    => skill_constants::ENV_SKILL_PATHS,

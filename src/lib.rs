...
fn register_utils(m: &Bound<'_, PyModule>) -> PyResult<()> {
    add_functions!(
        ...
        dcc_mcp_pybridge::type_wrappers::py_unwrap_value,
        dcc_mcp_pybridge::type_wrappers::py_unwrap_parameters,
        dcc_mcp_pybridge::type_wrappers::py_wrap_value,
        ...
        dcc_mcp_pybridge::py_json::json_dumps,
        dcc_mcp_pybridge::py_json::json_loads,
        dcc_mcp_pybridge::py_yaml::yaml_loads,
        dcc_mcp_pybridge::py_yaml::yaml_dumps,
    );
    add_classes!(
        m,

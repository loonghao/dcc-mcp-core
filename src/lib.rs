...
fn register_utils(m: &Bound<'_, PyModule>) -> PyResult<()> {
    add_functions!(
        ...
        dcc_mcp_utils::filesystem::py_get_user_skill_paths_from_env,
        dcc_mcp_utils::filesystem::py_get_team_skill_paths_from_env,
        dcc_mcp_utils::filesystem::py_get_app_user_skill_paths_from_env,
        dcc_mcp_utils::filesystem::py_get_app_team_skill_paths_from_env,
        dcc_mcp_utils::filesystem::py_get_user_skills_dir,
        dcc_mcp_utils::filesystem::py_get_team_skills_dir,
        dcc_mcp_utils::filesystem::py_copy_skill_to_user_dir,
        dcc_mcp_utils::filesystem::py_copy_skill_to_team_dir,
        dcc_mcp_utils::filesystem::py_record_skill_feedback,
        dcc_mcp_utils::filesystem::py_get_skill_feedback,
        dcc_mcp_utils::filesystem::py_get_skill_version_manifest,

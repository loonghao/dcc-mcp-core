    ...
    return [
        {
            ...
            "parameters": [
                {"name": "radius", "type": "float", "description": "Radius of the sphere", "default": 1.0},
                {"name": "segments", "type": "int", "description": "Number of segments", "default": 8},
            ],
...
def test_create_action_template(
    mock_open,
    mock_generate_content,
    mock_exists,
    mock_makedirs,
    mock_get_actions_dir,
...
@patch("dcc_mcp_core.actions.generator.get_actions_dir")
@patch("os.path.exists")
def test_create_action_template_file_exists(mock_exists, mock_get_actions_dir, sample_function_list, temp_actions_dir):
...
def test_create_action_template_exception(
    mock_open,
    mock_generate_content,
    mock_exists,
    mock_makedirs,
...
@patch("dcc_mcp_core.actions.generator.get_actions_dir")
def test_generate_action_for_ai_success(
    mock_get_actions_dir,
    mock_parse_description,
    mock_create_template,
    sample_function_list,
    sample_functions_description,
    temp_actions_dir,
):
    ...
    mock_create_template.assert_called_once_with("maya", "test_action", "Test action description", sample_function_list)


@patch("dcc_mcp_core.actions.generator.create_action_template")
@patch("dcc_mcp_core.actions.generator._parse_functions_description")
@patch("dcc_mcp_core.actions.generator.get_actions_dir")
def test_generate_action_for_ai_failure(
    mock_get_actions_dir,
    mock_parse_description,
    mock_create_template,
    sample_function_list,
...
@patch("dcc_mcp_core.actions.generator._parse_functions_description")
@patch("dcc_mcp_core.actions.generator.get_actions_dir")
def test_generate_action_for_ai_exception(
    mock_get_actions_dir, mock_parse_description, sample_functions_description, temp_actions_dir
):

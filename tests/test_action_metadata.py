...
from dcc_mcp_core.actions.metadata import extract_action_metadata, create_action_model, create_actions_info_model
from dcc_mcp_core.models import ActionModel, FunctionModel, ParameterModel
...
def test_basic_action_metadata(action_manager, test_data_dir):
    ...
    # Get action info
    action_info = action_manager.get_action_info("basic_plugin")
    
    # Verify the returned object is an ActionModel
...
def test_minimal_action_metadata(action_manager, test_data_dir):
    ...
    # Get action info
    action_info = action_manager.get_action_info("minimal_plugin")
...
def test_maya_action_metadata(action_manager, test_data_dir):
    ...
    # Get action info
    action_info = action_manager.get_action_info("maya_plugin")
...
def test_advanced_types_action_metadata(action_manager, test_data_dir):
    ...
    # Get action info
    action_info = action_manager.get_action_info("advanced_types_plugin")
...
def test_internal_helpers_action_metadata(action_manager, test_data_dir):
    ...
    # Get action info
    action_info = action_manager.get_action_info("internal_helpers_plugin")

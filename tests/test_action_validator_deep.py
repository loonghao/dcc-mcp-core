"""Tests for ToolValidator deep validation coverage.
...
class TestActionValidatorFromActionRegistry:
    ...
    def test_creates_validator_for_registered_action(self):
        ...
        av = ToolValidator.from_action_registry(reg, "create_sphere")
        assert av is not None
    ...
    def test_from_registry_with_dcc_name(self):
        ...
        av = ToolValidator.from_action_registry(reg, "create_sphere", dcc_name="maya")
    ...
    def test_from_registry_no_schema_action(self):
        ...
        av = ToolValidator.from_action_registry(reg, "no_schema_action")
